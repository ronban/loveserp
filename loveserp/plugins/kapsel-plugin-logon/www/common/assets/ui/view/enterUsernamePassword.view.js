sap.ui.jsview("view.enterUsernamePassword", {
    ...
    createContent: function(oController) {
            ...
            var inputUsername = new sap.m.Input( 'username_input', {
                    value:"{/user}",
                    placeholder:getLocalizedString("SCR_ENTER_USERNAME_PASSWORD_USERNAME"),
            });

            var inputPassword = new sap.m.Input( 'password_input', {
                    type:sap.m.InputType.Password,
                    value:"{/password}",
                    placeholder:getLocalizedString("SCR_ENTER_USERNAME_PASSWORD_PASSWORD"),
                    liveChange:function() {
